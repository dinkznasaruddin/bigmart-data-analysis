...
Project ini adalah tugas big data yang melakukan analisis data penjualan BigMart menggunakan teknologi NoSQL (MongoDB) dan distributed computing (Apache Spark).
